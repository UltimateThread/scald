...
namespace SCALD_RENDERING {
   ...
   {
      auto uniformIter = m_UniformLocationMap.find(uniformName);
      if (uniformIter != m_UniformLocationMap.end())
      ...
      {
         SCALD_ERROR("Uniform [{0}] not found in the shader!", uniformName);
         return -1;
      }
